...
function AgentMessage({ message }: { message: ChatMessage }) {
  ...
  return (
    <div className="flex gap-2.5 mr-auto max-w-[95%] agent-message-enter min-w-0">
      {/* Agent icon */}
      ...
      <div className="flex flex-col gap-2 flex-1 min-w-0 overflow-hidden">
        ...
        {/* Message content */}
        {message.content && (
          <div className="rounded-lg bg-muted/50 px-3 py-2.5 overflow-hidden">
...
function UserMessage({ message }: { message: ChatMessage }) {
  return (
    <div className="flex gap-2.5 ml-auto max-w-[85%] flex-row-reverse agent-message-enter min-w-0">
      ...
      <div className="rounded-lg bg-primary text-primary-foreground px-3 py-2 text-sm overflow-hidden">
